...
/obj/item/device/flashlight/flare
	...
	var/frng_min = 800	//haven - flare minimum
	var/frng_max = 1000 //haven - flare maximum
	heat = 1000
	light_color = LIGHT_COLOR_FLARE

/obj/item/device/flashlight/flare/New()
	fuel = rand(frng_min, frng_max) // Sorry for changing this so much but I keep under-estimating how long X number of ticks last in seconds. //Haven - changed to min/max instead of numbers
	..()
